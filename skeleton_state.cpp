...
{
    Vector<BoneState *> new_bones;
    Vector<TransformState *> new_transforms;
    Vector<ConstraintState *> new_constraints;
    Vector<TargetState *> new_targets;
    for (auto &bone : bones)
    {
